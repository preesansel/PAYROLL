...
public class PayrollService {
    ...
    public List<Payroll> calculatePayrolls() {
        ...
        try {
            taxResponse = restTemplate.exchange(
...
//
//        payrolls = payrolls.stream().filter(p -> p != null).toList(); // Replaced Stream.collect(Collectors.toList()) with Stream.toList()
//        payrollRepository.saveAll(payrolls);
//
//        return payrolls;
//    }
    ...
    public EmployeeDetails getEmployeeDetails(Long employeeId) {
        EmployeeDetails employeeDetails = employeeRepository.findEmployeeDetailsById(employeeId);
